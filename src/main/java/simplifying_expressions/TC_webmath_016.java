...
public class TC_webmath_016 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Sheet s = wb.getSheet("TC_webmath_016");
			...
			boolean anythingelse = driver.findElement(By.linkText(s.getCell(1, 2).getContents())).isDisplayed();
