...
public class TC_webmath_049 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Sheet s = wb.getSheet("TC_webmath_049");
			...
			WebElement f1 = driver.findElement(By.name(s.getCell(1, 11).getContents()));

			driver.switchTo().frame(f1);
			Thread.sleep(2000);

			if (driver.getPageSource().contains(s.getCell(1, 12).getContents())) {
