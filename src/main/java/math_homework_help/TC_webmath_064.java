...
public class TC_webmath_064 {

	public static void main(String[] args) {
		WebDriver driver = WebDriverManager.chromedriver().create();
		try {
			FileInputStream f = new FileInputStream("D:\\ExcelR Webmath Project\\Math_Homework_Help.xls");

			Workbook wb = Workbook.getWorkbook(f);

			Sheet s = wb.getSheet("TC_webmath_064");
			...
			boolean cosmeo = driver.findElement(By.linkText(s.getCell(1, 2).getContents())).isDisplayed();
			if (cosmeo == true) {
